...
//	@HystrixCommand(fallbackMethod = "metodoAlternativo")
	...
	//para manejar tolerancia a fallos con histrix, hay que agregar la anotacion @HistrixCommand
	// y en el string fallBackMethod pasarle el nombre del metodo alternativo en caso de error.
